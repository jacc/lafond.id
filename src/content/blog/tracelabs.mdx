...
A few weeks ago, my coworker and friend [Alexa](https://www.linkedin.com/in/alexa-feminella-9bb1b5241/) approached me about doing a capture the flag event that was hosted by Trace Labs - Search Party, a 4 hour OSINT-based CTF where you search for missing persons. I had never done a publicly organized CTF like this before, but I've always been incredibly interested in OSINT (shoutout SIA!), so I gladly purchased a ticket and signed up.
