...
homeTitle: "TraceLabs' Search Party CTF 2024 - First Place"
description: "How Team F!ND won our first ever Search Party CTF"
pubDate: "2024 Apr 20"
heroImage: "/winners.png"
slug: "tracelabs"
hidden: true
---
...
<p class="bg-yellow-100 border-l-4 border-yellow-600 p-4 max-w-5xl">
  {`Disclaimer: For the safety, confidentiality and privacy of the families, much
  of the information about the flags related to the missing persons (MPs) will
  be redacted or vague.`}
</p>

A few weeks ago, my coworker and friend [Alexa](https://linkedin.com/in/alexa-feminella) approached me about doing a capture the flag event that was hosted by Trace Labs - Search Party, a 4 hour OSINT-based CTF where you search for missing persons. I had never done a publicly organized CTF like this before, but I've always been incredibly interested in OSINT (shoutout SIA!), so I gladly purchased a ticket and signed up.

Our team consisted of Alexa, our wonderful professor [Angela Ramos](https://linkedin.com/angela-ramos), and [Osama](https://linkedin.com/osama) (who was recruited by Angela.) Angela is a TL veteran, having done a few of these events before, and Osama is a fellow student of ours.
...
<p class="bg-blue-100 border-l-4 border-blue-600 p-4 max-w-5xl">
  {`From this point on, I'll be referring to the missing persons as MPs (ex, MP1,
  MP2, etc.) to keep their identities private.`}
</p>
...
Time was up, we were in first with 7100 points, and the energy was absolutely eletric. After a few minutes, we started to see the chart adjust. We dropped from first to second, back to first, then back to second where we sat below Ghost Recon Unit. We were all a bit nervous, but regardless incredibly proud of what we had accomplished.

After about 30 minutes, I checked the leaderboard again and saw that the chart had adjusted again - we were back in first. We had won.
...
- [Alexa](https://linkedin.com/in/alexa-feminella) - Thank you for inviting me to this event and for being an incredible teammate. I can't wait to do more of these with you.
- [Angela](https://linkedin.com/angela-ramos) - Thank you for being an incredible mentor and teammate. I learned so much from you in this event, and I can't wait to do more with you.
- [Osama](https://linkedin.com/angela-ramos) - Clutching up on the flags in the last 30 minutes - without Osama's finds on MP4, we might have not placed first
