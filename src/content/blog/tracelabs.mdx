...
A few weeks ago, my coworker and friend [Alexa](https://www.linkedin.com/in/alexa-feminella-9bb1b5241/) approached me about doing a capture the flag event that was hosted by Trace Labs - Search Party, a 4 hour OSINT-based (for the uninitiated, OSINT is open source intelligence - or the process of gathering information from public sources) CTF where you search for missing persons. I had never done a publicly organized CTF like this before, but I've always been incredibly interested in OSINT (shoutout SIA!), so I gladly purchased a ticket and signed up.
...
- [Alexa](https://www.linkedin.com/in/alexa-feminella-9bb1b5241/) - Thank you for inviting me to this event and for being an incredible teammate. I can't wait to do more of these with you.
- [Angela](https://www.linkedin.com/in/angelaramos2/) - Thank you for being an incredible mentor and teammate. I learned so much from you in this event, and I can't wait to do more with you.
- [Osama](https://www.linkedin.com/in/osama-shilbayeh/) - Clutching up on the flags in the last 30 minutes - without Osama's finds on MP4, we might have not placed first
